...
namespace lve {
	...
	void FirstApp::createPipeline() {
		...
		lvePipeline = std::make_unique<LvePipeline>(
			lveDevice,
			"C:\\Users\\suraj\\OneDrive\\Documents\\Visual Studio Projects\\Vulkan Notes\\Swap Chain Recreation and Dynamic Viewports\\simple_shader.vert.spv",
			"C:\\Users\\suraj\\OneDrive\\Documents\\Visual Studio Projects\\Vulkan Notes\\Swap Chain Recreation and Dynamic Viewports\\simple_shader.frag.spv",
			pipelineConfig);
