...
namespace lve {
	...
	void SimpleRenderSystem::createPipeline(VkRenderPass renderPass) {
		...
		lvePipeline = std::make_unique<LvePipeline>(
			lveDevice,
			"C:\\Users\\suraj\\OneDrive\\Documents\\Visual Studio Projects\\Vulkan Notes\\Camera (View) Transform\\simple_shader.vert.spv",
			"C:\\Users\\suraj\\OneDrive\\Documents\\Visual Studio Projects\\Vulkan Notes\\Camera (View) Transform\\simple_shader.frag.spv",
			pipelineConfig);
