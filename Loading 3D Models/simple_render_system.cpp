...
namespace lve {
	...
	void SimpleRenderSystem::createPipeline(VkRenderPass renderPass) {
		...
		lvePipeline = std::make_unique<LvePipeline>(
			lveDevice,
			"C:\\Users\\suraj\\OneDrive\\Documents\\Visual Studio Projects\\Vulkan Notes\\Loading 3D Models\\simple_shader.vert.spv",
			"C:\\Users\\suraj\\OneDrive\\Documents\\Visual Studio Projects\\Vulkan Notes\\Loading 3D Models\\simple_shader.frag.spv",
			pipelineConfig);
