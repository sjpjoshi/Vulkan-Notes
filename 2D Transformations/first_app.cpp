...
namespace lve {
	...
	void FirstApp::createPipeline() {
		...
		lvePipeline = std::make_unique<LvePipeline>(
			lveDevice,
			"C:\\Users\\suraj\\OneDrive\\Documents\\Visual Studio Projects\\Vulkan Notes\\2D Transformations\\simple_shader.vert.spv",
			"C:\\Users\\suraj\\OneDrive\\Documents\\Visual Studio Projects\\Vulkan Notes\\2D Transformations\\simple_shader.frag.spv",
			pipelineConfig);
